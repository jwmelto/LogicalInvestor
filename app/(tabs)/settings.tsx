...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontWeight: '600', color: '#888', marginBottom: 6, textTransform: 'uppercase' },
  ...
  forumHeaderArrow: { fontSize: 16, color: '#666', fontWeight: '600', width: 16 },
  ...
  silencedTopicsLabel: { fontSize: 14, fontWeight: '600', color: '#666', marginBottom: 8, textTransform: 'uppercase' },
  emptyState: { fontSize: 15, color: '#999', fontStyle: 'italic', paddingVertical: 8 },
  ...
  silencedTopicName: { fontSize: 15, fontWeight: '500', color: '#1a1a1a', flex: 1 },
  ...
  resubscribeButtonText: { fontSize: 13, fontWeight: '600', color: '#0066cc' },
  ...
  levelButtonText: { fontSize: 15, fontWeight: '600' },
  levelHint: { fontSize: 14, fontStyle: 'italic' },
  buildInfo: { fontSize: 14, textAlign: 'center', marginTop: 16, marginBottom: 8 },
});
